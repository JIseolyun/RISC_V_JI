...
module rom(
    ...
    initial begin
        ...
        rom[0] = 32'b0000000_00001_00010_000_00100_0110011;  // ADD //12 + 11 = 23 //x4 = x2 + x1
        rom[1] = 32'b0100000_00001_00010_000_00101_0110011;  // SUB //12 - 11 = 1 // x5, x2, x1
        //rom[x]=32'b imm7  _ rs2  _ rs1 _ f3 _ imm5 _ opcode; // S-Type
        rom[2] = 32'b0000000_00010_00000_010_01000_0100011;  //  sw x2, 8(ram0);
        //rom[x]=32'b imm12      _ rs1_ f3 _ rd _ opcode; // L-Type
        rom[3] = 32'b000000000000_  ?  _010_  ?  _0000011; // LW 
